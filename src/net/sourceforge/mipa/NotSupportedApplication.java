...
public class NotSupportedApplication extends AbstractApplication {

	public NotSupportedApplication() {
		super();
	}
	...
	public void run() throws NotBoundException, IOException {
		...
		while(true) {
			...
			if(input.trim().equals("1")) {
				...
				register("config/predicate/predicate_not_supported.xml", onRegister, "not-supported");
	...
	public static void main(String[] args) throws NotBoundException, IOException {
		NotSupportedApplication app = new NotSupportedApplication();
		app.run();
	}
}
