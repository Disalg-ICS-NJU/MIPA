...
public class CTLApplication extends AbstractApplication {

	public CTLApplication() {
		super();
	}
	...
	public void run() throws NotBoundException, IOException {
		...
		while(true) {
			...
			if(input.trim().equals("1")) {
				...
				register("config/predicate/predicate_ctl.xml", onRegister, "ctl");
	...
	public static void main(String[] args) throws NotBoundException, IOException {
		CTLApplication app = new CTLApplication();
		app.run();
	}
}
