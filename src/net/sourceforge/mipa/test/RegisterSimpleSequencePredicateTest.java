...
public class RegisterSimpleSequencePredicateTest {
	 ...
	 * @throws Exception
	 */
	public void testRegisterSimpleSequencePredicate() throws Exception {
        ...
        Document predicate_1 = parseXml("config/predicate/predicate_oga.xml");
    	OnFire callback_1 = new OnFire();
        predicateID = broker.registerPredicate(callback_1, predicate_1);
        assertTrue(predicateID != null);
        assertTrue(groupManager.getPredicateInfo(predicateID)!=null);
        Thread.sleep(5000);
        assertTrue(callback_1.isFlag());
