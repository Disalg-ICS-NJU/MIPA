...
public class DecompositionApplication extends AbstractApplication {

	public DecompositionApplication() {
		super();
	}
	...
	public static void main(String[] args) throws NotBoundException, IOException {
		DecompositionApplication app = new DecompositionApplication();
		app.run();
	}
}
