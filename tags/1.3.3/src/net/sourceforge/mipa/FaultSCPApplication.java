...
public class FaultSCPApplication extends AbstractApplication {

	public FaultSCPApplication() {
		super();
	}
	...
	public void run() throws NotBoundException, IOException {
		...
		while(true) {
			...
			if(input.trim().equals("1")) {
				...
				register("config/predicate/predicate_scp_fault.xml", onRegister, "scp-fault");
			}else if(input.trim().equals("2")) {
				unregister("scp-fault");
			}
	...
	public static void main(String[] args) throws NotBoundException, IOException {
		FaultSCPApplication app = new FaultSCPApplication();
		app.run();
	}
}
