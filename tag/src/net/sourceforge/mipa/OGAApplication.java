...
public class OGAApplication extends AbstractApplication {

	public OGAApplication() {
		super();
	}
	...
	public void run() throws NotBoundException, IOException {
		...
		while(true) {
			...
			if(input.trim().equals("1")) {
				...
				register("config/predicate/predicate_oga.xml", onRegister, "oga");
	...
	public static void main(String[] args) throws NotBoundException, IOException {
		OGAApplication app = new OGAApplication();
		app.run();
	}
}
