...
public class UnRegisterPredicateTest {
	...
	@Test
	/**
	 * 支持以谓词描述的面向异步环境的环境特性的注销
	 * @throws Exception
	 */
	public void testUnRegisterPredicate() throws Exception {
		//service.startService();
		...
		Document predicate = parseXml("config/predicate/predicate_wcp_1.xml");
