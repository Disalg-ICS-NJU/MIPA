...
public class RegisterPredicateTest {
	...
	@Test
	/**
	 * 支持以谓词描述的面向异步环境的环境特性的注册
	 * 支持XML格式的谓词描述的环境特性
	 * @throws Exception
	 */
	public void testRegisterPredicate() throws Exception {
        ...
        //支持以谓词描述的面向异步环境的环境特性
		Document predicate = parseXml("config/predicate/predicate_wcp.xml");
