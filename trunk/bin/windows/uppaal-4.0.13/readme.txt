...
This is the 4.0.13 release of UPPAAL 4.0 -- a model checker
for timed automata.
...
uppaal-4.0.13 containing at least the files uppaal, uppaal.jar, and the
...
4. We will only use UPPAAL for non-profit and academic research
   purposes, specifically for personal use without any link to
   industry or by employees and students of institutions that
